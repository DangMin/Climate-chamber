...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(75).setImmediate, __webpack_require__(0)))
...
var serialize = function serialize(element) {
  ...
  Array.prototype.forEach.call(inputs, function (input) {
    if (input.name.match(/.*\[\]/g)) {
      var prop = new RebExp(/.*[^\[\]]/).exec(input.name);
...
var c = {
  view: function view() {
    return (0, _mithril2.default)('.program-display', [(0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Program:"), (0, _mithril2.default)('p.program-display__body', "program-name")]), (0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Cycles:"), (0, _mithril2.default)('p.program-display__body', "number-of-cycle")]), (0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Steps:"), (0, _mithril2.default)('p.program-display__body', "number-of-step")]), (0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Current step:"), (0, _mithril2.default)('p.program-display__body', "current-step")]), (0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Next step:"), (0, _mithril2.default)('p.program-display__body', "next-step")]), (0, _mithril2.default)('div', [(0, _mithril2.default)('p.program-display__header', "Time remaining:"), (0, _mithril2.default)('p.program-display__body', "time-remaining")])]);
  }
};
...
function SegmentDisplay(displayId, config) {
...
var _serialState = __webpack_require__(40);
...
var c = {
  oninit: function oninit(vnode) {
    _serialState2.default.update;
  },
  view: function view() {
    return (0, _mithril2.default)('.row', [(0, _mithril2.default)('.col-md-8', [(0, _mithril2.default)('p', 'Serial connection state: ', [(0, _mithril2.default)('i.fa.fa-circle', { class: _serialState2.default.state ? 'state--active' : 'state--unactive' })])]), (0, _mithril2.default)('.col-md-4 .status-bar__right', [_serialState2.default.state ? (0, _mithril2.default)('button', { onclick: _serialState2.default.disconnect }, 'Disconnect') : (0, _mithril2.default)('button', { onclick: _serialState2.default.reqConnection }, 'Connect')])]);
  }
};
...
var SerialState = {
  ...
  update: function () {
    socket.on('serial-status', function (data) {
      console.log(data);
      if (data.err) {
...
var _programTable = __webpack_require__(27);

var _programTable2 = _interopRequireDefault(_programTable);

var _serialState = __webpack_require__(30);

var _serialState2 = _interopRequireDefault(_serialState);

var _segmentDisplay = __webpack_require__(29);

var _segmentDisplay2 = _interopRequireDefault(_segmentDisplay);

var _programs = __webpack_require__(28);
...
(0, _domready2.default)(function () {
  var components = {
    'program-table-js': _programTable2.default,
    'serialport-state-js': _serialState2.default,
    'programs-js': _programs2.default
  };

  var thermoDisplay = new _segmentDisplay2.default('thermo-display-js');
  var humidDisplay = new _segmentDisplay2.default('humid-display-js');
