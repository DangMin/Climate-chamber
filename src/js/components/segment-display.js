...
function SegmentDisplay(displayId, config) {
  ...
  this.value           = config.value || '12:34:56';
  this.digitHeight     = config.digitHeight || 20;
  this.digitWidth      = config.digitWidth || 10;
  this.digitDistance   = config.digitDistance || 2.5;
  this.displayAngle    = config.displayAngle || 12;
  this.segmentWidth    = config.segmentWidth || 2.5;
  this.segmentDistance = config.segmentDistance || 0.2;
  this.segmentCount    = config.segmentCount || SegmentDisplay.SevenSegment;
  this.cornerType      = config.cornerType || SegmentDisplay.RoundedCorner;
  this.colorOn         = config.colorOn || 'rgb(233, 93, 15)';
  this.colorOff        = config.colorOff || 'rgb(75, 30, 5)';
};
